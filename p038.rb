...
#
#     iが9桁の場合、max_nは1
#       これは問題よりmax_n>1なので、このケースは考えない
#
#   ここまでのまとめ
#     (1) iの探索範囲はiが2桁〜4桁のケースを探せばよい(11〜9999)
#     (2) max_nの探索範囲は2〜4
#     (3) iのはじめの桁は9のはず
#         探索範囲は91〜98, 912〜999, 9123〜9876
#         pandigital数であることを考えると、同じ数が2回登場するiは対象外
#
#   そんなに数が多い訳じゃないので(1)(2)と(3)をちょっとだけ使って探索してみるか。
#
...
max_pandigital = 918273646

# あとは総当たりで...
(91..9876).each{|i|
  n = concatenated_product(i, max_n[i.digit])
  if pandigital?(n)
    puts "hit!! i=#{i}, n=#{n}"
    if n > max_pandigital
      max_pandigital = n
